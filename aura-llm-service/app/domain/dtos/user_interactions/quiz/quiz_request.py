...
class QuizGenerateRequest(BaseModel):
    mode: QuizMode = Field(
        ...,
        description=(
            "direct: genera el cuestionario solo con el texto provisto por el usuario. "
    ...
    messages: list[Message] = Field(
        ...
        description=(
            ...
            "con el material a evaluar o instrucción de refinamiento."
        ),
    )
    chat_id: int = Field(
        ...,
    ...
    def validate_last_message_is_human(self) -> "QuizGenerateRequest":
