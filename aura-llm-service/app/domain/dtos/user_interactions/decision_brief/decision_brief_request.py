...
class DecisionBriefMode(StrEnum):
    DIRECT = "direct"
    RAG = "rag"


class DecisionBriefGenerateRequest(BaseModel):
    mode: DecisionBriefMode = Field(
        ...,
        description=(
            "direct: genera el brief solo con el texto provisto por el usuario. "
    ...
    messages: list[Message] = Field(
        ...
        description=(
            ...
            "con el problema/decisión a analizar o instrucción de refinamiento."
        ),
    )
    chat_id: int = Field(
        ...,
    ...
    def validate_last_message_is_human(self) -> "DecisionBriefGenerateRequest":
