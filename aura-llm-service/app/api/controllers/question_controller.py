...
from app.api.controllers.interfaces.question_controller_interface import QuestionControllerInterface
...
class QuestionController(QuestionControllerInterface):
