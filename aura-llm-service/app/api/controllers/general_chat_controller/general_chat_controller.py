...
from app.api.controllers.general_chat_controller.general_chat_controller_interface import (
    GeneralChatControllerInterface,
)
from app.api.openapi.common import default_error_responses
from app.application.authorization.authorizer import Authorizer
from app.application.authorization.permissions import Permissions
from app.application.services.general_chat_service.general_chat_service import get_general_chat_service
...
from app.domain.dtos.general_chat.general_chat_stream_events import GeneralChatStreamEvent
...
def _format_sse_event(event: GeneralChatStreamEvent) -> str:
