...
from app.domain.dtos.document_action.document_action_stream_events import (
        ...
        try:
            ...
            if state.strategy == ProcessingStrategy.direct:
                yield DocumentActionStreamProgress(
                    ...
                    message="Ejecutando la acción sobre el documento...",
                )
                try:
                ...
                yield DocumentActionStreamProgress(
                    step="reducing",
                    message="Consolidando resultados en la respuesta final...",
                )
                try:
