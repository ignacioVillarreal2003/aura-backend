...
from app.application.services.document_action_service.steps.retrieve_fragments.retrieve_fragments_settings import (
...
class RetrieveFragmentsPlugin(DocumentActionPlugin):
    ...
    async def run(
        ...
        fragments_by_document: dict[int, list[ContextFragmentResponse]] = {}
        all_fragments: list[ContextFragmentResponse] = []
