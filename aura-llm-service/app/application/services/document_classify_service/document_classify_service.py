...
from app.application.services.document_classify_service.document_classify_prompt import (
    HUMAN_PROMPT,
    SYSTEM_PROMPT,
)
...
from app.application.services.document_classify_service.document_classify_state import DocumentClassifyState
...
class DocumentClassifyService(DocumentClassifyServiceInterface):
    ...
    async def classify_document(
        ...
        logger.info(
            "Document classification initiated",
            extra={
