...
from app.application.services.rag_agent_service.rag_agent_settings import QueryAnalyzerSettings
    ...
    async def _ensure_llm_initialized(self) -> None:
        ...
        async with self._llm_lock:
            ...
            try:
                ...
                raise RuntimeError("Failed to initialize LLM for query analyzer") from e
