...
class DocumentQuestionServiceSettings(BaseSettings):
    ...
    max_attached_fragments: int = Field(default=10, ge=1, le=50)
    max_context_chars: int = Field(default=12_000, ge=1_000, le=50_000)

    attached_reduction_batch_chars: int = Field(default=6_000, ge=1_000, le=20_000)
    attached_max_reduction_passes: int = Field(default=2, ge=1, le=5)
