...
from app.application.services.user_interactions.document_summary_service.processors.chunk_document_summary_processor.chunk_document_summary_prompt import (
    CHUNK_SYSTEM_PROMPT,
    CHUNK_HUMAN_PROMPT,
)
