...
from app.application.services.user_interactions.document_action_service.processors.chunk_document_action_processor.chunk_document_action_prompt import (
    CHUNK_SYSTEM_PROMPT,
    CHUNK_HUMAN_PROMPT,
