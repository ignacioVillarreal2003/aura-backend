...
class DocumentQuestionServiceSettings(BaseSettings):
    ...
    question_max_fragments: int = Field(default=3, ge=1, le=50)
    keywords_max_fragments: int = Field(default=3, ge=1, le=50)
    use_rerank: bool = Field(default=False)
    rerank_max_fragments: Optional[int] = Field(default=None)
