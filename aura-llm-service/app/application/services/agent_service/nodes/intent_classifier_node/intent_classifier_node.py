...
from app.application.services.agent_service.agent_settings import IntentClassifierSettings
    ...
    async def _ensure_llm_initialized(self) -> None:
        ...
        async with self._llm_lock:
            ...
            try:
                ...
                raise RuntimeError("Failed to initialize LLM for intent classifier") from e
