...
from app.application.services.document_question_service.steps.rerank_context.rerank_context_settings import (
...
class RerankContextPlugin(DocumentQuestionPlugin):
    ...
    async def run(
        ...
        fragments: list[ContextFragmentResponse] = state.retrieved_fragments
        ...
        try:
            ...
            ranked: list[tuple[float, ContextFragmentResponse]] = sorted(
