    ...
    def _validate_document_id(
        ...
        logger.debug(
            ...
            extra={
                ...
                "min_document_id": self._document_summary_configuration.min_document_id,
                "max_document_id": self._document_summary_configuration.max_document_id
            }
        )

        if not (self._document_summary_configuration.min_document_id
                <= document_id
                <= self._document_summary_configuration.max_document_id):
            logger.warning(
            ...
            raise ValidationError(
                ...
                f"Debe estar entre {self._document_summary_configuration.min_document_id} y {self._document_summary_configuration.max_document_id}. "
