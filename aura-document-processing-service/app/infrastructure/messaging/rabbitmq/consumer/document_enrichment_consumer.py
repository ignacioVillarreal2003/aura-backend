...
class DocumentEnrichmentConsumer(BaseConsumer[DocumentEnrichmentCommand], DocumentEnrichmentConsumerInterface):
    def __init__(
            self,
    ...
    async def _process(self, envelope: MessageEnvelope[DocumentEnrichmentCommand]) -> None:
