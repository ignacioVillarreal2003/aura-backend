...
class FragmentQueryServiceAuthorizer:
    def require_permissions(
        ...
        logger.warning(
            "Insufficient permissions for the fragment query operation.",
            extra={
        ...
        raise FragmentQueryUnauthorizedException("You do not have permission to query fragments.")
    ...
    def require_roles(
        ...
        logger.warning(
            "Insufficient role for the fragment query operation.",
            extra={
                "user_id": authenticated_user.id,
        ...
        raise FragmentQueryUnauthorizedException("You do not have the required role for this fragment query.")
    ...
    def require_ownership(
        ...
        raise FragmentQueryUnauthorizedException("You are not authorized to access this document.")
