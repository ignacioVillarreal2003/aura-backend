...
VALUES
       ...
       ('LLM_FRAGMENT_CONTEXTUALIZE', 'Contextualización de fragmentos (Contextual Retrieval)'),
       ...
       ('LLM_FEEDBACK_EVALUATION', 'Evaluación de feedback negativo mediante LLM juez'),
