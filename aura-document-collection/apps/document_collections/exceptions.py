...
class CollectionAccessDeniedException(ForbiddenException):
    def __init__(self, detail: str | None = None):
        super().__init__(
            ...
            error_code="collection_access_denied",
        )
...
class CollectionOwnerRequiredException(ForbiddenException):
    def __init__(self, detail: str | None = None):
        super().__init__(
            detail=detail or "Only the collection owner can perform this action",
            error_code="collection_owner_required",
        )
...
class CannotRemoveOwnerException(ForbiddenException):
    def __init__(self):
        super().__init__(
            detail="Cannot remove the collection owner from the collection",
...
class OwnerCannotLeaveException(ForbiddenException):
    def __init__(self):
        super().__init__(
            detail="Collection owner cannot leave; delete the collection or transfer ownership",
...
class DuplicateMembershipException(ConflictException):
    def __init__(self):
        super().__init__(
            detail="User is already in this collection",
...
class DuplicateDocumentLinkException(ConflictException):
    def __init__(self):
        super().__init__(
            detail="Document is already linked to this collection",
