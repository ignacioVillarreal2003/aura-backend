"""purge_notifications management command — hard-deletes eligible soft-deleted notifications."""
...
class Command(BaseCommand):
    help = (
        'Hard-delete notifications that have been soft-deleted for more than '
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=None,
            help='Override NOTIFICATION_HARD_DELETE_DAYS setting for this run.',
        )
        parser.add_argument(
            '--dry-run',
            action='store_true',
    ...
    def handle(self, *args, **options):
        ...
        msg = f'Hard-deleted {deleted} notification(s) soft-deleted before {cutoff.date()} ({days} days ago).'
